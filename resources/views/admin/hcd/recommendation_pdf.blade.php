        ...
        <div class="oed-section">
            ...
            <table class="form-table" style="border: none; margin-bottom: 0;">
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 70%; border-bottom: 1px solid #000; padding-top: 35px; margin-bottom: 4px;"></div>
                        <div style="width: 70%; text-align: center; font-weight: bold; text-transform: uppercase;">
