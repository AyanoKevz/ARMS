...
@section('title', 'Report of Changes — Reports')
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fas fa-exchange-alt me-2" style="color: var(--portal-gold);"></i> Report of Changes Reports</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel" style="border-top: 3px solid #0b3d91;">
                <div class="x_title">
                    <h2><i class="fas fa-list-alt me-2" style="color: #0b3d91;"></i> All Report of Changes Submissions</h2>
                ...
                <div class="x_content">
                    <div class="table-responsive">
                        <table id="report_changes_admin_table"
                                ...
                                @foreach($ntcReports as $ntc)
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-info text-white" style="font-size:0.75rem; padding: 5px 10px; border-radius: 20px;">Report of Changes</span>
                                        </td>
