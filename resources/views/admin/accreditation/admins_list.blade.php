...
@section('title', 'Accreditation Admin List')
...
@php
    // This portal has a single role (Verifier), so there is no Team Lead to gate on.
    // Any admin in the Accreditation division may invite another.
    $canInvite = true;
@endphp
...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Accreditation Admin List</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Administrators in the Accreditation Division</h2>
        ...
        <div class="modal-content">
            ...
            <form id="createAdminForm">
                ...
                <div class="modal-body">
                    ...
                    {{-- No role picker: every admin in this portal is a Verifier, so the
                         role is assigned server-side by the controller. --}}
                    <div class="alert alert-light border small mb-0">
                        <i class="fas fa-info-circle me-1"></i>
                        This invitation grants the <strong>Verifier</strong> role in the
                        <strong>Accreditation</strong> division.
                    </div>
                </div>
...
$(document).ready(function() {
    $('#createAdminForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route('admin.accreditation.directory.admins.invite') }}',
            type: 'POST',
            data: $form.serialize(),
