    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 hero-content">
                ...
                <h1 class="hero-title">
                    Advocate a <em>Safe</em> and <em>Healthy</em> Workplace
                </h1>
                <p class="hero-lead">
            ...
            <div class="col-lg-5 offset-lg-1 hero-image-side mt-5 mt-lg-0">
                <div class="hero-btns">
                    <a href="{{ route('register') }}" class="btn-hero-primary">
                        <i class="bi bi-file-earmark-check"></i> Apply Accreditation
                    </a>
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-8 col-lg-6">
                <div class="portal-card text-center">
                    ...
                    <p class="mb-1">
                        For <strong>OSH Professionals</strong>, <strong>Technical Service Provider</strong>, and
                        <strong>Safety Training and Consultancy Organizations</strong> — manage your accreditation in one place.
                    </p>

                    <ul class="portal-sub-list text-start mt-3 mb-4">
                        <li>OSH Practitioners &amp; Consultants</li>
                        <li>Work and Environment Measurement Providers (WEM)</li>
                        <li>Construction Heavy Equipment Testing Organizations (CHETO)</li>
                        <li>Safety Training Organizations (STO)</li>
                        <li>Safety Consultancy Organizations (SCO)</li>
                        <li>First Aid Training Providers (FATPro)</li>
                    </ul>
