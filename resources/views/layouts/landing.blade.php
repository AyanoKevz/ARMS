...
<body>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-4">
                                <div class="footer-logo">
                                    <img src="{{ asset('images/oshc-logo.png') }}" alt="OSHC Logo" loading="lazy">
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="footer-contact-item">
                                        ...
                                        <a href="mailto:oed@oshc.dole.gov.ph"
                                            style="color:rgba(255,255,255,.55);text-decoration:none;">oed@oshc.dole.gov.ph</a>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- GSAP core + plugins (cdnjs 3.13.0) --}}
